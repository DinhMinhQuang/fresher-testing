...
module.exports = {
  async Apply(instanceName, projectDir) {
    try {
      global.meCore.projects[instanceName].mongoose = global.meCore.projects[instanceName].mongoose ? global.meCore.projects[instanceName].mongoose : {
        connections: {},
        models: {},
        autoIncrement: {}
      };

      const connections = global.meCore.projects[instanceName].mongoose.connections;
      const models = global.meCore.projects[instanceName].mongoose.models;
      const autoIncrement = global.meCore.projects[instanceName].mongoose.autoIncrement;
      ...
      const pathModelList = await Filehound.create()
        ...
        .glob('*Model.js')
        .find();
      _.forEach(pathModelList, (pathModel) => {
